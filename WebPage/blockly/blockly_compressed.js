...
goog.html.TrustedResourceUrl.formatWithParams = function(a, b, c) {
	...
	b = /\?/.test(a) ? "&" : "?";
	for (var d in c) null != c[d] && (a += b + encodeURIComponent(d) + "=" + encodeURIComponent(String(c[d])), b = "&");
...
goog.html.SafeStyle.create = function(a) {
	...
	for (c in a) {
		...
		var d = a[c];
		if (null != d) {
			if (d instanceof goog.string.Const) d = goog.string.Const.unwrap(d), goog.asserts.assert(!/[{;}]/.test(d), "Value does not allow [{;}].");
			else {
				d = String(d);
	...
	for (var f = null, g = 0, h; h = a.childNodes[g]; g++)
		if (3 != h.nodeType) {
			var k = null,
				l = null;
			f = 0;
			for (var m; m = h.childNodes[f]; f++) 1 == m.nodeType && ("block" == m.nodeName.toLowerCase() ? k = m : "shadow" == m.nodeName.toLowerCase() && (l = m));
			!k && l && (k = l);
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
	...
	if (goog.isArray(a)) {
		...
		if (!(b || 2 > a.length)) {
			var e = [];
			for (c = 0; c < a.length; c++) e.push(a[c][0]);
